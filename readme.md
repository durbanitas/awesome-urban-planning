# Awesome Urban Planning List

A curated list of awesome urban planning resources, tools, and projects that are open source or free to use.
...
- [Spatial Design and Analysis Software](#spatial-design-and-analysis-software)
...
Collection of awesome open source and free tools and resources to use as a urban planner or architect. Feel free to contribute by submitting a PR.

## Research

### Governement Publications

- [Australian Government Publications](https://www.directory.gov.au/govdex) - Offers a directory of government resources, including publications on urban planning, infrastructure, and public policy.
- [GOV.uk - United Kingdom Publications](https://www.gov.uk/) - Official website of the UK government.
- [India - National Institute of Urban Affairs](http://www.niua.org/) - Offers publications and reports on urban development, policies, and planning.
...
- [World Bank Open Data](https://data.worldbank.org/) - Provides a listing of available World Bank datasets, including databases, pre-formatted tables, reports, and other resources.
...
- [Places Journal](https://placesjournal.org/) - Places Journal is a nonprofit publication dedicated to exploring architecture, landscape, and urbanism.
...
- [Mapillary](https://www.mapillary.com/app/) - Access street-level imagery and map data from all over the world.
...
- [OSM Buildings](https://osmbuildings.org/) - Free and open source web viewer for 3D buildings.
...
- [GNU PSPP](https://www.gnu.org/software/pspp/) -  PSPP is a free and open-source software for statistical analysis.
...
- [RoadDetection](https://github.com/microsoft/RoadDetections) - Road detections from Microsoft Maps aerial imagery.
...
- [Vectr](https://vectr.com/) - Free vector graphics editor.
...
- [Atlas Obscura](https://www.atlasobscura.com) - Guidebook and tour-guide to the world's most wondrous places. Travel tips, articles, strange facts and unique events.
...
- [CivicSearch](https://civicsearch.org) - CivicSearch is a search and discovery tool for everything that is said in local government meetings, texts, and laws across hundreds of cities and towns in the U.S. and Canada.
...
Feel free to contribute by adding more resources or improving existing ones. Follow the [contribution guidelines](https://github.com/durbanitas/awesome-urban-planning/blob/master/contributing.md).
